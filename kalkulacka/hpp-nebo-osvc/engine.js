...
(function (root) {
  ...
  function spocitej(v) {
    ...
    // HPP
    {
      ...
      const dan = danFO(zaklad, odpocty);
    ...
    const danP = danFO(ziskP, odpocty);
    ...
    const danS = danFO(ziskS, odpocty);
  ...
  const api = { P, VARIANTY, DEFAULTS, spocitej, pasmoPausalniDane };
